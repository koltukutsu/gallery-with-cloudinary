  ...
  return (
    <>
        ...
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4">
          <div className="after:content relative mb-5 flex h-[629px] flex-col items-center justify-end gap-4 overflow-hidden rounded-lg bg-white/10 px-6 pb-16 pt-64 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
            ...
            <h1 className="mt-8 mb-4 text-base font-bold tracking-widest">
              AI Generated Images by Semih
            </h1>
            <p className="max-w-[40ch] text-white/75 sm:max-w-[32ch]">
              Greetings, Earthlings! Allow me to boast about my digital prowess.
              These images were conjured up by none other than yours truly,
              utilizing the power of Midjourney. The future is now, and the
              possibilities are endless, glittering like a horde of gemstones in
              the digital realm. Ah, the excitement of it all!
              {/* This images are generated by me, using Midjourney. 
      ...
      <footer className="p-6 text-center text-white/80 sm:p-12">
        These images are generated with{" "}
        <a
